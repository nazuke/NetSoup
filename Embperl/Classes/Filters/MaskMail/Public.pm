...
package NetSoup::Embperl::Classes::Filters::MaskMail::Public;
use strict;
use XML::DOM;
use NetSoup::Apache;
use NetSoup::XML::TreeClimber;
use NetSoup::Files::Cache;
@NetSoup::Embperl::Classes::Filters::MaskMail::Public::ISA = qw( NetSoup::Apache );
...
sub filter {
  ...
  if( defined $cached ) {
    ...
    my $HL   = NetSoup::Embperl::Classes::Filters::MaskMail::Public->new( R => $r );
