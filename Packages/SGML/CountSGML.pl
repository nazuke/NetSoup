#!/usr/local/bin/perl
#
#   NetSoup::Packages::XML::CountSGML.pl v00.00.01a 12042000
#
...
#
#
#   Description: This Perl 5.0 script counts words in SGML files.
#
#
#         Usage: CountSGML.pl file [file1] [file2] ...
