#!/usr/local/bin/perl
#
#   NetSoup::Packages::HyperGlot::cgi-bin::Logout.cgi v00.00.01z 12042000
#
...
#                This script logs a user out of the system.
...
print( STDOUT $cookie->set( Key    => "HyperGlotStatus",                # Set new cookie
							Value  => "LoggedOut",
							Expire => $time->minutes(1),
							Domain => $hostname ) );
line( "Location: http://$hostname/HyperGlot/login/logout.shtml\r\n" );  # Logged out message
exit(0);
